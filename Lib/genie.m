% Genie upper bound
function [btp1,st,profit,rt_market,tot_profit,dual_ramp] = genie(wind,prices,D,C,beta,batinitial,contract_initial,ramping)
    if nargin<8
        ramping = C;
    end
    if C==0
    ...
    cvx_begin quiet
        ...
        rt_market = [contract_initial;st(1:L-D)]+(btp1-[batinitial;btp1(1:end-1)]) - wind ;
